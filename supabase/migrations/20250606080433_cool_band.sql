-- Criar usuário teste completamente limpo (sem dados de restaurante)
DO $$
DECLARE
  user_id_var uuid;
  user_exists boolean;
BEGIN
  ...
  IF NOT user_exists THEN
    -- Criar novo usuário sem dados de restaurante
  ...
  ELSE
    -- Atualizar usuário existente removendo dados de restaurante
